...
$(function() {
	...
	describe('RSS Feeds', function() {
		...
		/* TODO: Write a test that loops through each feed
		 * in the allFeeds object and ensures it has a name definedexpect(foo).not.toBeNull();expect(foo).not.toBeNull();
	...
	describe('New Feed Selection', function() {
		...
		it('loadFeed Entries ', function() {
			loadFeed(1);
			currentContainer = $('.feed').html()   
			expect(firstContainer).not.toEqual(currentContainer);
